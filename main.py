...
with st.form("churn_form"):
    ...
    TotalCharges = st.text_input("Total Charges")  # Some total charges can be blank or non-numeric
...
if submit:
    ...
    # Combine with df_1 to match expected dummies
